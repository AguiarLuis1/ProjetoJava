...
*/
            ...
            //bd.createStForCaminhos(bd, graphs);
            //graphs.criarGrafoEmpresasSeguidasporProfissisonais(bd);
            //graphs.criarGrafoCaminhos(bd,graphs);
        ...
        for (Integer i : bd.getStFinal().keys()) {
            ...
            if (j == 0) {
                if (bd.getStFinal().get(i).getObj() instanceof Empresa) {
                    System.out.println("Empresas:");
                    j++;
                }
            }
            if (k == 0) {
                if (bd.getStFinal().get(i).getObj() instanceof Encontro) {
                    System.out.println("Encontro:");
                    k++;
                }
            }
            if (m == 0)
                if (bd.getStFinal().get(i).getObj() instanceof PontosP) {
                    System.out.println("Pontos de Passagem:");
                    m++;
                }


            System.out.println(bd.getStFinal().get(i));
        }
